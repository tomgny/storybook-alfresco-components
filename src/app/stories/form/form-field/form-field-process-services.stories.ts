...
import { AlfrescoApiService, AuthenticationService, CoreModule, MaterialModule } from '@alfresco/adf-core';
import { BrowserAnimationsModule } from '@angular/platform-browser/animations';
import { RouterModule } from '@angular/router';
import { Meta, moduleMetadata, Story } from '@storybook/angular';
import { APP_ROUTES } from '../../../app.routes';
import { AppCommonModule } from '../../../components/common/common.module';
import { AlfrescoApiCompatibilityServiceStub, AuthenticationServiceStub } from '../mock/stub-services';
...
export default {
  ...
  decorators: [
    moduleMetadata({
      ...
      providers: [
        { provide: AlfrescoApiService, useClass: AlfrescoApiCompatibilityServiceStub },
